...
const EventDetails = () => {
  ...
  const recordViewInteraction = async () => {
    try {
      ...
      // Ne pas afficher d'erreur � l'utilisateur pour cette op�ration silencieuse
    }
  };
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Afficher un modal pour proposer d'ajouter l'�v�nement au calendrier
      if (response.calendarLinks) {
        setCalendarLinks(response.calendarLinks);
        setShowCalendarModal(true);
      }

      // Si un QR code a �t� g�n�r�, le stocker
  ...
  // Fonctions pour ajouter l'�v�nement au calendrier
    ...
    <div className="event-details-container">
      ...
      <div className="event-details-content-wrapper">
        <Container>
          ...
          {/* Modal pour ajouter l'�v�nement au calendrier */}
